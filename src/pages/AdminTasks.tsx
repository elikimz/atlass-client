...
export default function AdminTasks() {
  ...
  const [formData, setFormData] = useState({ title: '', description: '', video_url: '', reward_amount: 0 })
  ...
  const handleEdit = (task: VideoTask) => {
    setFormData({ title: task.title, description: task.description || '', video_url: task.video_url, reward_amount: task.reward_amount })
