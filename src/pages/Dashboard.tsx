...
export default function Dashboard() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
      ...
      {/* Main Container for Table and Journey */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        
        {/* Journey Quick View (New Addition to maintain functionality in design) */}
        <div style={{
          backgroundColor: 'white', borderRadius: '30px', padding: '30px',
          boxShadow: '0px 10px 60px rgba(226, 236, 249, 0.5)',
          ...
          <div>
            <h2 style={{ fontSize: '20px', fontWeight: 600, color: 'black', margin: '0 0 4px' }}>Your Journey</h2>
        ...
        {/* Real Stats from Backend (Footage, Roles, etc.) */}
        <div style={{
        ...
        {/* Customers Table Card (EXACTLY AS IN IMAGE) */}
        <div style={{
          backgroundColor: 'white', borderRadius: '30px', padding: '30px',
          boxShadow: '0px 10px 60px rgba(226, 236, 249, 0.5)'
        }}>
